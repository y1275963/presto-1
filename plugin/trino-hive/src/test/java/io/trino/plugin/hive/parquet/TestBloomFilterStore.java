...
public class TestBloomFilterStore
{
    ...
    public Object[][] bloomFilterTypeTests()
    {
        return new Object[][] {
                ...
                },
                {
                        ...
                        new BloomFilterTypeTestCase(
                                Arrays.asList(32.22f, 341112.2222f, 43232.222121f, 32322.22f, Float.POSITIVE_INFINITY, Float.NEGATIVE_INFINITY, Float.MIN_NORMAL, Float.MAX_VALUE),
                ...
                },
                {
                        ...
                        new BloomFilterTypeTestCase(
                                Arrays.asList((short) 32, (short) 3000, (short) -32768, (short) 32767),
                ...
                {
                        // a fixed length character data (hardcoded as 30 in test case)
                        new BloomFilterTypeTestCase(
                                Arrays.asList("hello", "parquet  ", "bloom", "filter"),
                                Arrays.asList("not", "exist", "testcaseX"),
                                createCharType(30),
                                new JavaHiveCharObjectInspector(getCharTypeInfo(30)))
                },
                {
            ...
            throws Exception
    {
        try (ParquetTester.TempFile tempFile = new ParquetTester.TempFile("testbloomfilter", ".parquet")) {
            ...
            TupleDomain<ColumnDescriptor> predicateMatches = withColumnDomains(singletonMap(columnDescriptor, multipleValues(typeTestCase.sqlType, typeTestCase.matchingValues)));
            ...
            TupleDomain<ColumnDescriptor> predicateNotMatches = withColumnDomains(singletonMap(columnDescriptor, multipleValues(typeTestCase.sqlType, typeTestCase.nonMatchingValues)));
            ...
            TupleDomain<ColumnDescriptor> predicateNotMatchesWrongColumn = withColumnDomains(singletonMap(columnDescriptor, multipleValues(typeTestCase.sqlType, typeTestCase.nonMatchingValues)));
